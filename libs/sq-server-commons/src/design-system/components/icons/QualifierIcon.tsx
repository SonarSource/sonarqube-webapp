...
function PortfolioIcon({ fill, ...iconProps }: Readonly<IconProps>) {
  return (
...
function ApplicationIcon({ fill, ...iconProps }: Readonly<IconProps>) {
  return (
    <CustomIcon {...iconProps}>
      <path
...
function SubPortfolioIcon({ fill, ...iconProps }: Readonly<IconProps>) {
  return (
    <CustomIcon {...iconProps}>
      <path
