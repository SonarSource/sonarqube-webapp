  ...
  return (
    <CustomIcon {...iconProps}>
      {raised ? (
        ...
        <Fragment>
          <circle cx="8" cy="8" fill={cssVar('color-icon-subtle')} r="7" />
          <path
        ...
        // eslint-disable-next-line react/jsx-fragments
        <Fragment>
          <circle cx="8" cy="8" fill={cssVar('color-background-neutral-bolder-default')} r="7" />
          <path
            ...
            fill={cssVar('color-icon-default')}
          />
        </Fragment>
      )}
    </CustomIcon>
