...
export enum SharedDocLink {
  ...
  JiraIntegration = '/instance-administration/integrations/jira-cloud',
  JiraIntegrationProjectBinding = '/project-administration/integrations/jira-cloud',
  JiraIntegrationTroubleshooting = '/instance-administration/integrations/jira-cloud#troubleshooting',
  ...
  SecurityAlerts = '/user-guide/security-alerts',
