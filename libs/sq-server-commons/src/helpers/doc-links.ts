...
export const DOC_URL = 'https://docs.sonarsource.com/sonarqube-server';
...
export enum DocLink {
  ...
  AlmAzureIntegration = '/discovering/devops-platforms/azure-devops',
  AlmBitBucketCloudAuth = '/instance-administration/authentication/bitbucket-cloud/',
  AlmBitBucketCloudIntegration = '/discovering/devops-platforms/bitbucket-cloud',
  AlmBitBucketCloudIntegrationApiToken = '/project-administration/creating-project/bitbucket-cloud/import-repos#step-1-create-an-api-token',
  ...
  AlmGitHubIntegration = '/discovering/devops-platforms/github',
  AlmGitHubMonorepoWorkfileExample = '/analyzing-source-code/ci-integration/github-actions#configure-build-yml',
  ...
  AlmGitLabIntegration = '/discovering/devops-platforms/gitlab',
  ...
  AnalysisScope = '/project-administration/adjusting-analysis/setting-analysis-scope/introduction',
  AnalysisScopeWildcardPatterns = '/project-administration/adjusting-analysis/setting-analysis-scope/defining-matching-patterns/',
  AuthOverview = '/instance-administration/authentication/overview/',
  BackgroundTasks = '/analyzing-source-code/background-tasks/',
  BackgroundTasksReIndexingSingleProject = '/server-update-and-maintenance/maintenance/reindexing#reindexing-single-project',
  BacklogFixSuggestions = '/user-guide/issues/with-ai-features/backlog-fix-suggestions',
  BranchAnalysis = '/discovering/code-analysis/branch-analysis',
  ...
  CIAnalysisSetup = '/analyzing-source-code/ci-integration',
  CIJenkins = '/analyzing-source-code/ci-integration/jenkins-integration/key-features/',
  CleanCode = '/quality-standards-administration/managing-rules/software-qualities',
  ...
  InstanceAdminEncryption = '/instance-administration/security/encrypting-settings',
  ...
  InstanceMonitoring = '/server-update-and-maintenance/troubleshooting/performance-issues',
  ...
  LlmProviders = '/instance-administration/ai-features/llm-providers',
  ...
  ProductSubscriptions = '/instance-administration/license-administration/product-subscriptions',
  PortfolioBreakdown = '/user-guide/viewing-reports/portfolios/#portfolio-breakdown',
  PortfolioManagementAllDashboards = '/user-guide/portfolio-dashboards/viewing-and-managing-dashboards',
  PortfolioManagementCreateDashboards = '/user-guide/portfolio-dashboards/creating-dashboards',
  Portfolios = '/user-guide/viewing-reports/portfolios/',
  ProjectManagementAllDashboards = '/user-guide/project-dashboards/viewing-and-managing-dashboards',
  ProjectManagementCreateDashboards = '/user-guide/project-dashboards/creating-dashboards',
  ProjectRemediationAgent = '/project-administration/ai-features/remediation-agent',
  ProjectRegulatoryReports = '/user-guide/viewing-reports/regulatory-reports/',
  PullRequestAnalysis = '/discovering/code-analysis/pull-request-analysis',
  ...
  RemediationAgent = '/instance-administration/ai-features/remediation-agent',
  RemediationAgentDopPermissions = '/instance-administration/ai-features/remediation-agent#devops-platform-permissions',
  Root = '/',
  ...
  RulesOverview = '/quality-standards-administration/managing-rules/rules',
  ...
  Webhooks = '/discovering/integrations/webhooks',
}
...
export enum SonarSourceLink {
  ...
  HunterLegalLink = '/legal/hunter-agent/',
