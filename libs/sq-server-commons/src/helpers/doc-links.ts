...
export enum DocLink {
  ...
  AlmGitHubMonorepoWorkfileExample = '/analyzing-source-code/ci-integration/github-actions#configuring-the-buildyml-file',
  ...
  PullRequestAnalysis = '/discovering/code-analysis/incremental-analysis',
