  ...
  return connected ? (
    ...
    >
      ...
      <path
        ...
        fill={cssVar('color-text-subtle')}
      />
      <g clipPath="url(#sqciok)" fill={cssVar('logos-colors-brand')}>
      ...
      <defs>
        <clipPath id="sqciok">
          <path d="M0 0h48v48H0z" fill="#fff" transform="translate(108.995 38)" />
        </clipPath>
      </defs>
    </svg>
  ) : (
    ...
    >
      ...
      <path
        ...
        strokeWidth="2"
      />
      <g clipPath="url(#sqcireq)" fill={cssVar('logos-colors-brand')}>
      ...
      <defs>
        <clipPath id="sqcireq">
          <path d="M0 0h48v48H0z" fill="#fff" transform="translate(119 38)" />
        </clipPath>
      </defs>
    </svg>
  );
