...
function getPageObject() {
  ...
  const ui = {
    ...
    // Add/remove metrics.
    addMetricBtn: byRole('button', {
      name: 'project_activity.graphs.custom.add',
    }),
    ...
    legendRemoveMetricBtn: (key: string) =>
      byRole('button', {
        name: `project_activity.graphs.custom.remove_metric.${key}`,
      }),
    ...
    // Data in table.
    openInTableRegion: byRole('region', {
      name: /project_activity.graphs.open_in_table/,
    }),
