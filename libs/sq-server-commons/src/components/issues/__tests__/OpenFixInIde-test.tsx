...
it('handles open in ide button click with several ides found when there is fix suggestion', async () => {
  ...
  const secondIde = screen.getByRole('menuitem', {
    name: MOCK_IDES_OPEN_FIX[1].ideName,
  });
...
function renderComponentOpenIssueInIdeButton(
  ...
  function Wrapper() {
    ...
    queryClient.setQueryData(['branches', 'mycomponent', 'details'], {
      branchLike: {},
    });
  ...
  return renderComponent(<Wrapper />, '/?id=mycomponent', {
