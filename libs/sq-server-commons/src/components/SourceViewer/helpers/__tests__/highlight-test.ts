...
describe('highlightSymbol', () => {
  it('should not highlight symbols with similar beginning', () => {
    ...
    expect(highlightSymbol(tokens, 'sym-1')).toEqual([
      ...
      { className: 'a sym-18 b', markers: [], text: 'foo', modifiers: {} },
      {
        className: 'sym-1 d highlighted',
        markers: [],
        text: 'bar',
        modifiers: {},
      },
      {
        className: 'c sym-1 highlighted',
        markers: [],
        text: 'bar',
        modifiers: {},
      },
      {
        className: 'c sym-1 d highlighted',
        markers: [],
        text: 'bar',
        modifiers: {},
      },
  ...
  it('should highlight symbols marked twice', () => {
    ...
    expect(highlightSymbol(tokens, 'sym-1')).toEqual([
      {
        className: 'sym sym-1 sym sym-2 highlighted',
        markers: [],
        text: 'foo',
        modifiers: {},
      },
      {
        className: 'sym sym-1 highlighted',
        markers: [],
        text: 'bar',
        modifiers: {},
      },
