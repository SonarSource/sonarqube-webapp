...
const defaultProject = [
  mockProject({ key: 'project1', name: 'Project 1', projectUuid: 'project1-uuid' }),
  mockProject({
    key: 'project2',
    name: 'Project 2',
  ...
  mockProject({
    ...
    projectUuid: 'project3-uuid',
  }),
  mockProject({
    key: 'projectProvisioned',
    name: 'Project 4',
    managed: true,
    projectUuid: 'projectProvisioned-uuid',
  }),
  mockProject({
    key: 'portfolio1',
    name: 'Portfolio 1',
    qualifier: ComponentQualifier.Portfolio,
    projectUuid: 'portfolio1-uuid',
  }),
  mockProject({
    key: 'portfolio2',
    name: 'Portfolio 2',
  ...
  mockProject({
    ...
    qualifier: ComponentQualifier.Portfolio,
    lastAnalysisDate: undefined,
    projectUuid: 'portfolio3-uuid',
  }),
  mockProject({
    key: 'application1',
    name: 'Application 1',
    qualifier: ComponentQualifier.Application,
    projectUuid: 'application1-uuid',
  }),
  mockProject({
    key: 'application2',
    name: 'Application 2',
