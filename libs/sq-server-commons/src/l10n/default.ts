...
export const defaultMessages = {
  ...
  'onboarding_dashboard.journey.analyze.full_ci.title': 'Move projects to full CI',
  'onboarding_dashboard.journey.analyze.full_ci.desc':
    '{count} projects are not getting the best scan results. Consider upgrading them to full CI configuration.',
  'onboarding_dashboard.journey.analyze.full_ci.cta': 'Configure',
  'onboarding_dashboard.journey.analyze.legend.full_ci': 'Full CI',
  'onboarding_dashboard.journey.analyze.legend.autoscan': 'Autoscan',
  ...
  'onboarding_dashboard.projects.filter.not_onboarded': 'Not imported',
