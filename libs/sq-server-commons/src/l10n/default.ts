...
export const defaultMessages = {
  ...
  'pull_request.gitlab': 'Merge Request',
  'pull_request.small': 'pull request',
  pull_requests: 'Pull Requests',
  'pull_requests.gitlab': 'Merge Requests',
  ...
  'ai_capabilities.llm_providers.supported_models.remediation_agent':
    'Remediation Agent — Claude Opus models, GPT-5.3 Codex, GPT-5.5, GPT-5.6 Sol',
  ...
  'ai_capabilities_server.hunter_agent.provider.help':
  ...
  'project_agent_activity.source.backlog': 'Manual',
  'project_agent_activity.source.scheduled': 'Automated',
  'project_agent_activity.source.pull_request': 'Pull request',
  ...
  'project_agent_activity.show_more': 'Show more',
  ...
  'issues.sort.label': 'Sort by',
  'issues.sort.PRIORITY': 'Priority',
  'issues.sort.FILE_LINE': 'File name',
  ...
  'issues.facet.standards': 'Compliance Category',
  ...
  'issues.facet.owaspLlmTop10_2025': 'OWASP Top 10 for LLM',
  'issues.facet.owaspAsvs_4.0': 'OWASP ASVS 4.0',
  'issues.facet.owaspAsvs_5.0': 'OWASP ASVS 5.0',
  'issues.facet.owaspMasvs_v2': 'OWASP MASVS',
  'issues.facet.owaspMobileTop10_2024': 'OWASP Mobile Top 10 2024',
  'issues.facet.sonarsourceSecurity': 'SonarSource',
  'issues.facet.stigAsd_v5r3': 'STIG ASD V5R3',
  'issues.facet.stigAsd_v6': 'STIG ASD V6',
  'issues.facet.pciDss_3.2': 'PCI DSS 3.2',
  'issues.facet.pciDss_4.0': 'PCI DSS 4.0',
  'issues.facet.cwe': 'CWE',
  'issues.facet.misra': 'MISRA',
  'issues.facet.wcag_2.2': 'WCAG 2.2',
  'issues.facet.wcag_2.1': 'WCAG 2.1',
  'issues.facet.wcag_2.0': 'WCAG 2.0',
  'issues.facet.sonarsource.show_more': 'Show more SonarSource categories',
  'issues.facet.stigAsd_v5r3.show_more': 'Show more STIG ASD V5R3 categories',
  'issues.facet.stigAsd_v5r3.show_less': 'Show less STIG ASD V5R3 categories',
  'issues.facet.stigAsd_v6.show_more': 'Show more STIG ASD V6 categories',
  'issues.facet.stigAsd_v6.show_less': 'Show less STIG ASD V6 categories',
  ...
  'dependencies.risk.what.license.category_prohibited':
    '{license} is considered a {category} license which is prohibited by the {profile} license profile.',
  ...
  'dependencies.properties.identified_using.tooltip': 'View files used to identify this dependency',
  ...
  'dependencies.risks.header.number_of_risks.releases_count':
    '{releasesCount} {newlyIntroduced, select, true {new } other {}}{releasesCount, plural, one {dependency} other {dependencies}}',
  ...
  'dependencies.risks.no_cvss_score': 'CVSS: Unscored (pending)',
  'dependencies.risks.cvss_title': 'CVSS score',
  'dependencies.risks.cvss_severity_critical': 'Critical',
  'dependencies.risks.cvss_severity_high': 'High',
  'dependencies.risks.cvss_severity_medium': 'Medium',
  ...
  'dependencies.risks.epss.withdrawn': 'N/A (withdrawn)',
  ...
  'dependencies.risk.how.find_alternative.license_body':
    'Because this dependency’s license is prohibited by the {profile} license profile, you will need to find a different dependency to meet your needs.',
  'dependencies.risk.how.license.view_allowed': 'View licenses allowed for this project',
  ...
  'sca.container_images.page': 'Container images',
  ...
  'sca.quality_gates.metric.sca_severity_any_security': 'Dependency security risk severity',
  ...
  'architecture.page.model.modal.move_component.warning':
    'When moving the component, all sibling relationships will be lost.',
  ...
  'architecture.oversized.table.component': 'Component',
  ...
  'architecture.split_responsibility.table.component': 'Component',
  ...
  'architecture.patterns.edit.spotlight.name.placeholder': 'Pattern name',
  'architecture.patterns.edit.spotlight.enable_interfaces': 'Enable interface design',
  ...
  'architecture.tangles.table.component': 'Component',
  ...
  'architecture.directives.nav': 'Directives',
  'architecture.directives.page': 'Directives',
  'architecture.directives.count': '{count, plural, one {1 directive} other {{count} directives}}',
  'architecture.directives.empty': 'No directives',
  'architecture.directives.info':
    'An architecture directive is an instruction to change the code, such as removing a relationship, or moving or renaming a component. Once created, it raises code issues shown in the deviations list. The directive completes and disappears once the code is fixed.',
  'architecture.directives.table.type': 'Type',
  'architecture.directives.type.relationship': 'Relationship',
  'architecture.directives.type.move': 'Move',
  'architecture.directives.type.rename': 'Rename',
  'architecture.directives.create.button': 'Create directive',
  'architecture.directives.delete.button': 'Delete directive',
  'architecture.project_relationships.page': 'Exit points',
  'architecture.project_relationships.nav': 'Exit points',
  ...
  'architecture.relationships.list.error':
    "Sorry, we couldn't load the relationships. Please try again later.",
  'architecture.relationships.create': 'Define relationship',
  'architecture.relationships.create.title': 'Define relationship',
  'architecture.relationships.edit.title': 'Edit relationship',
  'architecture.relationships.edit.saved': 'Relationship saved successfully.',
  'architecture.relationships.edit.error': 'Failed to save relationship. Please try again.',
  'architecture.relationships.delete.error': 'Failed to delete relationship. Please try again.',
  'architecture.relationships.form.name': 'Name',
  'architecture.relationships.form.name.invalid': 'Only letters, numbers, and hyphens are allowed.',
  'architecture.relationships.form.language': 'Language',
  'architecture.relationships.form.direction': 'Direction',
  'architecture.relationships.form.direction.entry_point': 'Entry point',
  ...
  'architecture.sdks.list.description':
  ...
  'architecture.sdks.list.info': 'SDKs information',
  'architecture.sdks.list.empty': 'There are no SDKs defined yet.',
  ...
  'projects.awaiting_scan.learn_more': 'Learn more in SonarQube documentation',
  ...
  'mttr.x_day': '{value} day',
  'mttr.x_days': '{value} days',
  'mttr.x_hour': '{value} hour',
  'mttr.x_hours': '{value} hours',
  'mttr.x_minutes': '{value} min',
  'mttr.x_month': '{value} month',
  'mttr.x_months': '{value} months',
  'mttr.x_year': '{value} year',
  'mttr.x_years': '{value} years',
  'mttr.short.x_days': '{value} d',
  'mttr.short.x_hours': '{value} hr',
  'mttr.short.x_months': '{value} mo',
  'mttr.short.x_years': '{value} yr',
  ...
  'portfolio_dashboard.breakdown.not_found.unknown_segment':
    'The selected segment is not present in this widget.',
  ...
  'settings.authentication.gitlab.form.allowedGroups.description.JIT':
    "Provision only the specified groups and their subgroups by adding each root group's exact GitLab URL slug",
  'settings.authentication.gitlab.form.allowedGroups.description.AUTO_PROVISIONING':
    'You can restrict provisioning to specific groups.',
  ...
  'settings.sandbox_issues.deferral_days.title':
    'Automatically transition sandboxed issues to open status',
  'settings.sandbox_issues.deferral_days.description':
    'Number of days a sandboxed issue stays “In sandbox” status before it is automatically transitioned to “Open” status. Use 0 to disable it.',
  ...
  'settings.slack.install_app.hint':
    'Did you know you can install SonarQube for Slack to multiple workspaces?',
  ...
  'settings.sandbox_issues.project.deferral_days.readonly':
    'Sandboxed issues {days, plural, =0 {are never automatically transitioned to “Open” status} one {are automatically transitioned to “Open” status after # day} other {are automatically transitioned to “Open” status after # days}}. Configured at the instance level. Contact your administrator for modifications.',
  ...
  'project_activity.graphs.custom.metric_no_history.coverage':
    'No coverage data available. Make sure coverage analysis is set up correctly.',
  ...
  'quality_gates.operator.GTE.issueSeverity': 'is greater than or equal to',
  'quality_gates.operator.LT.issueSeverity': 'is less than',
  ...
  'my_account.set_notifications_for': 'Search for a project by name',
  'my_account.set_notifications_for.title': 'Add a project',
  'my_account.set_notifications_for.help': 'Minimum 2 characters',
  ...
  'metric.new_sca_count_vulnerability.name': 'New vulnerable dependency risks',
  'metric.new_sca_count_licensing.description': 'Prohibited license dependency risks',
  'metric.new_sca_count_licensing.name': 'New prohibited license dependency risks',
  ...
  'metric.new_sca_rating_any_issue.name': 'New dependency risk rating',
  'metric.new_sca_rating_any_security.name': 'New dependency security risk rating',
  'metric.new_sca_rating_vulnerability.name': 'New dependency risk rating for vulnerabilities',
  'metric.new_sca_rating_licensing.name': 'New dependency risk rating for licenses',
  'metric.new_sca_rating_malware.name': 'New dependency risk rating for malicious packages',
  'metric.new_sca_severity_any_issue.name': 'New dependency risk severity',
  'metric.new_sca_severity_any_security.name': 'New dependency security risk severity',
  'metric.new_sca_severity_vulnerability.name': 'New dependency vulnerability severity',
  'metric.new_sca_severity_licensing.name': 'New dependency with prohibited license',
  'metric.new_sca_severity_malware.name': 'New dependency malicious package severity',
  ...
  'metric.sca_count_vulnerability.name': 'Vulnerable dependency risks',
  'metric.sca_count_licensing.description': 'Prohibited license dependency risks',
  ...
  'metric.sca_rating_any_issue.name': 'Dependency risk rating',
  'metric.sca_rating_any_security.name': 'Dependency security risk rating',
  'metric.sca_rating_vulnerability.name': 'Dependency risk rating for vulnerabilities',
  'metric.sca_rating_licensing.name': 'Dependency risk rating for licenses',
  'metric.sca_rating_malware.name': 'Dependency risk rating for malicious packages',
  'metric.sca_severity_any_issue.name': 'Dependency risk severity',
  'metric.sca_severity_any_security.name': 'Dependency security risk severity',
  'metric.sca_severity_vulnerability.name': 'Dependency vulnerability severity',
  'metric.sca_severity_licensing.name': 'Dependency with prohibited license',
  'metric.sca_severity_malware.name': 'Dependency malicious package severity',
  ...
  //
  //------------------------------------------------------------------------------
  'monitoring.alerts.performance_troubleshooting_guide':
    'See the performance troubleshooting guide',
  ...
  'compliancereport.total_issues_button': 'View all {Category} issues',
  ...
  'onboarding_dashboard.journey.import.modal.title': 'Import repositories',
  ...
  'onboarding_dashboard.journey.analyze.description':
    'For full coverage and deep insights, consider moving as many projects as you can to CI-based analysis.',
  'onboarding_dashboard.journey.analyze.not_scanned.title': 'Not analyzed',
  'onboarding_dashboard.journey.analyze.not_scanned.desc':
    'These projects have not yet reported an analysis result. This may happen if analysis has not been set up, has not run successfully, or no code has been analyzed yet.',
  ...
  'onboarding_dashboard.journey.analyze.not_imported.desc':
    'These repositories have not been imported yet. Import them to start analyzing their code.',
  ...
  'onboarding_dashboard.journey.analyze.repositories_count': '{count} repositories',
  'onboarding_dashboard.journey.analyze.legend.analyzed': 'Analyzed',
  'onboarding_dashboard.journey.analyze.legend.not_scanned': 'Not analyzed',
  ...
  'onboarding_dashboard.journey.analyze.modal.description':
    'Projects with the status "not analyzed" need CI configuration to get analysis results.',
  ...
  'onboarding_dashboard.journey.overtime.title': 'Project coverage timeline',
  'onboarding_dashboard.journey.overtime.description':
    'Track your repository imports and project analysis, month by month.',
  'onboarding_dashboard.journey.overtime.description.analysis_only':
    'Track your project analysis, month by month.',
  'onboarding_dashboard.journey.overtime.legend.projects_scanned': 'Projects analyzed',
  ...
  'onboarding_dashboard.stale.title': 'Commits not being analyzed',
  'onboarding_dashboard.stale.loading': 'Loading stale projects',
  'onboarding_dashboard.stale.description':
    "These projects have commits that haven't been analyzed in the past 7 days.",
  ...
  'onboarding_dashboard.stale.col.last_scan': 'Last analysis',
  ...
  'onboarding_dashboard.projects.col.onboarding': 'Analysis status',
  ...
  'onboarding_dashboard.projects.action.how_to_run_new_scan': 'How to run a new analysis',
  'onboarding_dashboard.projects.action.view_project': 'View project',
  'onboarding_dashboard.projects.filter.scan_status.label': 'Analysis status',
  'onboarding_dashboard.projects.filter.analysis_mode.label': 'Analysis mode',
  'onboarding_dashboard.projects.filter.all': 'All',
  'onboarding_dashboard.projects.filter.scanned': 'Analyzed',
  'onboarding_dashboard.projects.filter.not_scanned': 'Not analyzed',
  'onboarding_dashboard.projects.filter.ci': 'CI-based analysis',
  'onboarding_dashboard.projects.filter.no_analysis_mode': 'None',
  'onboarding_dashboard.projects.onboarding.scanned': 'Analyzed',
  'onboarding_dashboard.projects.onboarding.scan_failed': 'Analysis failed',
  'onboarding_dashboard.projects.onboarding.imported_empty': 'Imported, not analyzed',
  'onboarding_dashboard.projects.analysis.full_ci': 'CI-based analysis',
  'onboarding_dashboard.projects.analysis.autoscan': 'Automatic analysis',
  'onboarding_dashboard.projects.gate.not_computed': 'Not computed',
  'onboarding_dashboard.repositories.loading': 'Loading repositories',
  'onboarding_dashboard.repositories.search': 'Search repositories...',
  'onboarding_dashboard.repositories.filter.visibility.label': 'Visibility',
  'onboarding_dashboard.repositories.filter.private': 'Private',
  'onboarding_dashboard.repositories.filter.public': 'Public',
  ...
  'security_alerts.sort.last_detected_at': 'Last Detection',
  'security_alerts.alert_type.dependency_risk': 'Dependency Risk',
  'security_alerts.status.open': 'Open',
  'security_alerts.status.resolved': 'Resolved',
  'security_alerts.status.count': '{status} ({count} shown)',
  'security_alerts.severity.aria_label': '{quality} {severity}',
  'security_alerts.no_results': 'No security alerts found',
  'security_alerts.total': '{count, plural, one {# alert} other {# alerts}}',
  'security_alerts.first_detected': 'First detected {date}',
  'security_alerts.last_detected': 'Last detected {date}',
  'security_alerts.affected_branches':
    '{count, plural, one {# affected branch} other {# affected branches}}',
  'security_alerts.affected_branches_more': 'and {count} more',
  'security_alerts.detail.back': 'Back to security alerts',
  'security_alerts.detail.not_found': 'Security alert not found',
  'security_alerts.detail.sca_issue.package': 'Package',
