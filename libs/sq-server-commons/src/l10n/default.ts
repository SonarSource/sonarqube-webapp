...
export const defaultMessages = {
  ...
  'layout.settings': '系统管理',
  'layout.architecture': 'Architecture',
  'layout.security_hotspots': 'Security hotspots',
  'layout.settings.TRK': '项目设置',
  'layout.settings.APP': '应用设置',
  'layout.settings.VW': '组合设置',
  'layout.settings.SVW': '组合设置',
  'layout.security_reports': 'Security reports',
  'layout.nav.home_logo_alt': 'Logo, link to homepage',
  'layout.nav.home_sonarqube_logo_alt': '{productName} 图标，点击返回首页',
  ...
  'page_title.template.default': '%s - 天融信AI代码审计平台',
  'page_title.template.with_category': '%s - {page} - 天融信AI代码审计平台',
  'page_title.template.with_instance': '{project} - %s - 天融信AI代码审计平台',
  ...
  'architecture.patterns.edit': 'Edit',
  ...
  'architecture.patterns.column.name': 'Name',
  'architecture.patterns.column.projects': 'Projects',
  'architecture.patterns.column.actions': 'Actions',
  'architecture.patterns.delete': 'Delete',
  ...
  'login.page': '登录',
  'login.login_to_sonarqube': '登录 {productName}',
  'login.login_with_x': '使用 {providerName} 登录',
  'login.more_options': '使用账号密码登录',
  'login.unauthorized_access_alert':
    '你没有权限访问该页面，请使用具备更高权限的账号重新登录。',
  'login.with_x': 'With {0}',
  'login.or': '或',
  'login.authentication_failed': '用户名或密码无效。',
  'login.logout_failed': '退出登录失败',
  'login.username.placeholder': '请输入用户名',
  'login.password.placeholder': '请输入密码',
  'login.hide_password': '隐藏密码',
  'login.show_password': '显示密码',
  'login.marketing.background.alt': '天融信品牌背景图',
  'login.marketing.logo.alt': '天融信AI代码审计平台 Logo',
  'login.marketing.title': '天融信AI代码审计平台',
  'login.marketing.description':
    '面向研发安全治理场景提供统一的 AI 代码审计能力，覆盖自研代码、开源组件和持续交付链路。',
  'login.marketing.continuous_verification': '持续验证：',
  'login.marketing.continuous_verification.description':
    '自动扫描代码变更，及时发现安全风险、缺陷与技术债务，降低问题进入生产环境的概率。',
  'login.marketing.devsecops_integrated': '融入 DevSecOps：',
  'login.marketing.devsecops_integrated.description':
    '无缝衔接现有研发流程，支持与常见 CI/CD 工具协同使用，提升治理闭环效率。',
  'login.marketing.empowering_developers': '赋能开发者：',
  'login.marketing.empowering_developers.description':
    '通过平台能力与研发工具联动，让开发人员更早获得可执行的修复建议与审计结果。',
  ...
  'my_profile.news_notifications.title': '平台新功能通知',
  ...
  'my_account.appearance': '界面外观',
  'my_account.appearance.title': '界面外观',
  'my_account.appearance.new_ui.title': '新版导航界面',
  'my_account.appearance.new_ui.description':
    '启用后可使用更清晰、更高效的新版导航界面；关闭后可切回旧版布局。',
  'my_account.appearance.new_ui.switch_label': '启用新版导航',
  ...
  'footer.version.status.active': '维护中',
  'footer.version.status.inactive': '已停止维护',
  'footer.web_api': 'Web API',
  'footer.mode.STANDARD': '标准体验',
  ...
  'indexation.page_unavailable.description': '{productName} 正在重新索引项目数据，请稍后刷新页面重试。',
