...
function QGNotComputed({
  ...
  return (
    <svg className={className} {...COMMON_PROPS} {...sizeProps}>
      <title>{title}</title>
      <rect
        fill={themeColor('qgIndicatorNotComputed')({ theme })}
        rx={rx}
        {...sizeProps}
      />
      {
...
function QGPassed({
  ...
  return (
    <svg className={className} {...COMMON_PROPS} {...sizeProps}>
      <title>{title}</title>
      <rect
        fill={themeColor('qgIndicatorPassed')({ theme })}
        rx={rx}
        {...sizeProps}
      />
      {
        {
          ...
          sm: (
            <>
              <path
                d="m11.3 5 .871.87-5.227 5.228-.87-.871z"
                fill={contrastColor}
              />
              <path
                d="m7.86 10.227-.872.871L4 8.11l.871-.871z"
                fill={contrastColor}
              />
            </>
          ),
...
function QGFailed({
  ...
  return (
    <svg className={className} {...COMMON_PROPS} {...sizeProps}>
      <title>{title}</title>
      <rect
        fill={themeColor('qgIndicatorFailed')({ theme })}
        rx={rx}
        {...sizeProps}
      />
      {
