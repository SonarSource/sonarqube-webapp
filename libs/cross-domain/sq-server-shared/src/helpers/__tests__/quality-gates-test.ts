...
const METRICS = {
  ...
  [MetricKey.new_maintainability_rating]: mockMetric({
    name: 'New Maintainability Rating',
  }),
  ...
  [MetricKey.new_reliability_rating]: mockMetric({
    name: 'New Reliability Rating',
  }),
  [MetricKey.new_bugs]: mockMetric({ name: 'New Bugs' }),
  [MetricKey.code_smells]: mockMetric({ name: 'Code Smells' }),
  [MetricKey.duplicated_lines_density]: mockMetric({
    name: 'Duplicated lines (%)',
  }),
  [MetricKey.security_review_rating]: mockMetric({
    name: 'Security Review Rating',
  }),
  [MetricKey.software_quality_reliability_rating]: mockMetric({
...
describe('getLocalizedMetricNameNoDiffMetric', () => {
  it('should return the correct corresponding metric', () => {
    ...
    expect(
      getLocalizedMetricNameNoDiffMetric(
        mockMetric({
          key: 'new_custom_metric',
          name: 'Custom Metric on New Code',
        }),
        METRICS,
      ),
