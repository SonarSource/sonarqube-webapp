...
export class QualityGatesServiceMock {
    ...
    this.readOnlyList = list || [
      mockQualityGate({
        ...
        conditions: [
          ...
          {
            id: 'AXJMbIUGPAOIsUIE3eNE',
            metric: 'reliability_rating',
            op: 'GT',
            error: '4',
          },
          {
            id: 'AXJMbIUGPAOIsUIE3eND',
          ...
          {
            id: 'AXJMbIUGPAOIsUIE3eNU',
            metric: 'new_reliability_rating',
            op: 'GT',
            error: '1',
          },
          {
            id: 'AXJMbIUGPAOIsUIE3eNV',
      ...
      mockQualityGate({
        ...
        conditions: [
          ...
          {
            id: 'AXJMbIUHPAOIsUIE3eOFoc',
            metric: 'new_coverage',
            op: 'LT',
            error: '80',
          },
          {
            id: 'AXJMbIUHPAOIsUIE3eNsoc',
            metric: 'new_security_rating',
            op: 'GT',
            error: '1',
          },
          {
            id: 'AXJMbIUHPAOIsUIE3eODoc',
            metric: 'new_reliability_rating',
            op: 'GT',
            error: '1',
          },
  ...
  showHandler = ({ name }: { name: string }) => {
    ...
    return this.reply({
      ...qualityGate,
      actions: this.computeActions(qualityGate),
    });
  };
  ...
  getAllQualityGateProjectsHandler = async ({
    ...
    const initialResponse = await this.searchProjectsHandler({
      gateName: '',
      query,
      selected,
    });
