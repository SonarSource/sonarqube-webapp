...
const ui = {
  ...
  projectLink: (name: string) => byRole('link', { name: new RegExp(name) }),

  definitionChangeLabel: byText('event.category.DEFINITION_CHANGE', {
    exact: false,
  }),
...
function renderEventInner(
  ...
  return renderAppWithComponentContext(
    ...
    () => (
      <Route
        path="*"
        element={<EventInner event={mockAnalysisEvent()} {...props} />}
      />
    ),
