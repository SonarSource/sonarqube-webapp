...
export function getTutorialActionButtons() {
  return {
    ...
    generateTokenButton: byRole('button', {
      name: 'onboarding.token.generate',
    }),
...
export function getTutorialBuildButtons() {
  return {
    ...
    mavenBuildButton: byRole('radio', {
      name: `onboarding.build.${BuildTools.Maven}`,
    }),
    gradleBuildButton: byRole('radio', {
      name: `onboarding.build.${BuildTools.Gradle}`,
    }),
    gradleDSLButton: (name: GradleBuildDSL) => byRole('radio', { name }),
    dotnetBuildButton: byRole('radio', {
      name: `onboarding.build.${BuildTools.DotNet}`,
    }),
    cppBuildButton: byRole('radio', {
      name: `onboarding.build.${BuildTools.Cpp}`,
    }),
    objCBuildButton: byRole('radio', {
      name: `onboarding.build.${BuildTools.ObjectiveC}`,
    }),
    dartBuildButton: byRole('radio', {
      name: `onboarding.build.${BuildTools.Dart}`,
    }),
    otherBuildButton: byRole('radio', {
      name: `onboarding.build.${BuildTools.Other}`,
    }),
    ...
    linuxButton: byRole('radio', {
      name: `onboarding.build.other.os.${OSs.Linux}`,
    }),
    windowsButton: byRole('radio', {
      name: `onboarding.build.other.os.${OSs.Windows}`,
    }),
    macosButton: byRole('radio', {
      name: `onboarding.build.other.os.${OSs.MacOS}`,
    }),
    arm64Button: byRole('radio', {
      name: `onboarding.build.other.architecture.arm64`,
    }),
    x86_64Button: byRole('radio', {
      name: `onboarding.build.other.architecture.x86_64`,
    }),
    autoConfigAutomatic: byRole('radio', {
      name: 'onboarding.build.cpp.autoconfig.automatic',
    }),
    autoConfigManual: byRole('radio', {
      name: 'onboarding.build.cpp.autoconfig.manual',
    }),
  };
}
