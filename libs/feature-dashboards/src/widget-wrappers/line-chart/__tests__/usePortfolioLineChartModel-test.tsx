...
import { usePortfolioLineChartModel } from '../PortfolioLineChartWidgetWrapper';
...
describe('usePortfolioLineChartModel', () => {
  it('requests portfolio series through the adapter', () => {
    const { result } = renderHook(() => usePortfolioLineChartModel(widgetProps, 'portfolio-id'), {
