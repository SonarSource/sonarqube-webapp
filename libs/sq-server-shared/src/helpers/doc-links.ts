...
export enum DocLink {
  ...
  InstanceAdminQualityProfiles = '/quality-standards-administration/managing-quality-profiles/',
  InstanceAdminQualityProfilesPrioritizingRules = '/quality-standards-administration/managing-quality-profiles/#prioritizing-rules',
