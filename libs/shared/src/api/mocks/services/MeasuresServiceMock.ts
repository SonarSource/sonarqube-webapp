...
export const MeasuresServiceDefaultDataset: MeasuresServiceData = {
  ...
  measuresByComponent: {
    ...
    'foo:src': [
      { metric: MetricKey.coverage, value: '93.3', component: 'foo:src' },
      { metric: MetricKey.duplicated_lines_density, value: '0.0', component: 'foo:src' },
      { metric: MetricKey.ncloc, value: '32648', component: 'foo:src' },
      { metric: MetricKey.sqale_index, value: '14', component: 'foo:src' },
      {
        metric: MetricKey.new_bugs,
        periods: [{ index: 1, value: '1', bestValue: false }],
        component: 'foo:src',
    ...
    'foo:foo:src:file1': [
      { metric: MetricKey.coverage, value: '93.3', component: 'foo:foo:src:file1' },
      { metric: MetricKey.security_rating, value: '1.0', component: 'foo:foo:src:file1' },
      { metric: MetricKey.reliability_rating, value: '1.0', component: 'foo:foo:src:file1' },
      { metric: MetricKey.duplicated_lines_density, value: '0.0', component: 'foo:foo:src:file1' },
      { metric: MetricKey.ncloc, value: '15000', component: 'foo:foo:src:file1' },
      { metric: MetricKey.sqale_index, value: '4', component: 'foo:foo:src:file1' },
      {
        metric: MetricKey.new_bugs,
        periods: [{ index: 1, value: '1', bestValue: false }],
        component: 'foo:foo:src:file1',
      },
    ],
    'foo:foo:src:file2': [
      { metric: MetricKey.coverage, value: '93.3', component: 'foo:foo:src:file2' },
      { metric: MetricKey.security_rating, value: '1.0', component: 'foo:foo:src:file2' },
      { metric: MetricKey.reliability_rating, value: '1.0', component: 'foo:foo:src:file2' },
      { metric: MetricKey.duplicated_lines_density, value: '0.0', component: 'foo:foo:src:file2' },
      { metric: MetricKey.ncloc, value: '15000', component: 'foo:foo:src:file2' },
      { metric: MetricKey.sqale_index, value: '4', component: 'foo:foo:src:file2' },
      {
        metric: MetricKey.new_bugs,
        periods: [{ index: 1, value: '0', bestValue: false }],
        component: 'foo:foo:src:file2',
      },
    ],
    'foo:foo:src:file3': [
      { metric: MetricKey.coverage, value: '97', component: 'foo:foo:src:file3' },
      { metric: MetricKey.security_rating, value: '1.0', component: 'foo:foo:src:file3' },
      { metric: MetricKey.reliability_rating, value: '1.0', component: 'foo:foo:src:file3' },
      { metric: MetricKey.duplicated_lines_density, value: '0.0', component: 'foo:foo:src:file3' },
      { metric: MetricKey.ncloc, value: '200', component: 'foo:foo:src:file3' },
      { metric: MetricKey.sqale_index, value: '4', component: 'foo:foo:src:file3' },
      {
        metric: MetricKey.new_bugs,
        periods: [{ index: 1, value: '0', bestValue: false }],
        component: 'foo:foo:src:file3',
      },
    ],
    'foo:foo:src:file4': [
      { metric: MetricKey.coverage, value: '90', component: 'foo:foo:src:file4' },
      { metric: MetricKey.security_rating, value: '1.0', component: 'foo:foo:src:file4' },
      { metric: MetricKey.reliability_rating, value: '1.0', component: 'foo:foo:src:file4' },
      { metric: MetricKey.duplicated_lines_density, value: '0.0', component: 'foo:foo:src:file4' },
      { metric: MetricKey.ncloc, value: '348', component: 'foo:foo:src:file4' },
      { metric: MetricKey.sqale_index, value: '1', component: 'foo:foo:src:file4' },
      {
        metric: MetricKey.new_bugs,
        periods: [{ index: 1, value: '0', bestValue: false }],
        component: 'foo:foo:src:file4',
      },
    ],
  },
