...
const INNER_CONTENT = <div>content</div>;

it('should render before expiration date', () => {
  renderWithContext(<Expiration date="2026-05-02T23:59:59.999Z">{INNER_CONTENT}</Expiration>);

  expect(screen.getByText('content')).toBeVisible();
});

it('should not render after expiration date', () => {
  renderWithContext(<Expiration date="2026-04-09T23:59:59.999Z">{INNER_CONTENT}</Expiration>);
