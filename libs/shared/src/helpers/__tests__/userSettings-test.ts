...
import {
  FEEShowSidebarNavigationSetting,
  getDefaultValueForSidebarNavigationUserSetting,
} from '../userSettings';
...
describe('getDefaultValueForSidebarNavigationUserSetting', () => {
  ...
  ])('should return default value <%s> when setting is "%s"', (expected, setting) => {
    expect(getDefaultValueForSidebarNavigationUserSetting(setting)).toBe(expected);
  });
});
