...
export function ThemeController() {
  ...
  const selectedTheme = useMemo(() => {
    if (isPrintMode) {
      return EchoesTheme.light;
    }

    if (themeMode === ThemeMode.System) {
      return isBrowserDarkColorSchemePreferred ? EchoesTheme.dark : EchoesTheme.light;
    }

    return themeMode === ThemeMode.Dark ? EchoesTheme.dark : EchoesTheme.light;
  }, [isPrintMode, themeMode, isBrowserDarkColorSchemePreferred]);
