...
import { getBitbucketServerRepositories } from '~sq-server-commons/api/alm-integrations';
...
import { mockBitbucketRepository } from '~sq-server-commons/helpers/mocks/alm-integrations';
