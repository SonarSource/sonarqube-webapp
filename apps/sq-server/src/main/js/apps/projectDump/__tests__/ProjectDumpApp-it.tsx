...
const ui = {
  ...
  successExport: byText('project_dump.latest_export_available.Jun 08, 2023', { exact: false }),
  pendingExport: byText('project_dump.pending_export.Jun 08, 2023', { exact: false }),
  ...
  successImport: byText('project_dump.import_success.Jun 08, 2023', { exact: false }),
  pendingImport: byText('project_dump.pending_import.Jun 08, 2023', { exact: false }),
