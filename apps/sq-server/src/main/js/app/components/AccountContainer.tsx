...
import { BareContainerWithNav } from '~shared/components/BareContainerWithNav';
import { GlobalNavUser } from './nav/global/GlobalNavUser';
...
export function AccountContainer() {
  return <BareContainerWithNav NavBar={AccountTopBar} />;
}
