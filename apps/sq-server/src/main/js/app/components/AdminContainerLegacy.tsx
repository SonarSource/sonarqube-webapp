...
export class AdminContainerLegacy extends React.PureComponent<AdminContainerProps, State> {
  intl = getIntl();
  mounted = false;
  ...
  render() {
    ...
    return (
      <>
        ...
        {this.portalAnchor && // portalAnchor does not exist in the migrated pages
          createPortal(
            <SettingsNav
...
export default withAppStateContext(AdminContainerLegacy);
