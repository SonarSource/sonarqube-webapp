...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '~addons': addonsAlias,
    '~architecture':
      '<rootDir>/private/libs/cross-domain/sq-server-features/architecture/src/index.ts',
    '~architecture/(.+)': '<rootDir>/private/libs/cross-domain/features/architecture/src/$1',
